...
public class MainActivity extends Activity {
    ...
    protected static final String DIALOG_FRAGMENT_TAG = "myFragment";
    protected static final String SECRET_MESSAGE = "Very secret message";
    protected static final String KEY_NAME_NOT_INVALIDATED = "key_not_invalidated";
    protected static final String DEFAULT_KEY_NAME = "default_key";
     ...
     */
    protected void tryEncrypt(Cipher cipher) {
        try {
